...
public class EditorActivity extends AppCompatActivity {
    ...
    private String name, species, breed, picture, birth, getId, pid, riwayat, kesehatan, vaksinasi, pengobatan;
...
//        uid = Common.currentUser.getId();
    ...
    private void postData(final String key) {
        ...
        String riwayat = mRiwayat.getText().toString().trim();
        String kesehatan = mKesehatan.getText().toString().trim();
        String vaksinasi = mVaksinasi.getText().toString().trim();
        String pengobatan = mPengobatan.getText().toString().trim();
        ...
        // Todo : Picture 4
        Call<Pets> call = mService.insertPet(key, name, species, breed, gender, birth, picture, uid, pid, riwayat, kesehatan, vaksinasi, pengobatan);
    ...
    private void updateData(final String key, final int id) {
        ...
        // Todo : Picture 6 OK
        Call<Pets> call = mService.updatePet(key, id,name, species, breed, gender, birth, picture, pid, riwayat, kesehatan, vaksinasi, pengobatan);
    ...
    private void deleteData(final String key, final int id, final String pic) {
        ...
        Call<Pets> call = mService.deletePet(key, id, pic);
    ...
    private void editMode(){
        ...
        mPid.setFocusableInTouchMode(true);
        mRiwayat.setFocusableInTouchMode(true);
        mKesehatan.setFocusableInTouchMode(true);
        mVaksinasi.setFocusableInTouchMode(true);
        mPengobatan.setFocusableInTouchMode(true);
